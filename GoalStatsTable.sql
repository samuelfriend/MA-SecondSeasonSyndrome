--GENERATING GF,GA TABLES

SELECT GF, GA FROM HUDD_BRI_CH_TABLE_1617
WHERE Squad = 'Brighton' or Squad = 'Huddersfield';

--GENERATING GF + GA STATS FOR SEASON
SELECT HB1617.Squad, 
